...
INITIAL_DATA = [
    ...
    {"NO": 14, "PRINCIPAL": "CYNOSURE", "PART NUMBER": "710-0138-110", "DESCRIPTION": "ASSY PCB, ETX COMPUTER INTERFACE", "QTY": 1},
    {
     ...
     "Qty_Buyback": 8, "Status": "Sudah sebagian",
     "Tanggal_Buyback": datetime.date(2025, 11, 27),
     "Catatan": "Erha Clinic Kelapa Gading 4 Pc (29 April 2026, Erha Clinic Lombok 1 Pc (30 Januari 2026), Erha Clinic Kombes Surabaya 2 Pc (19 Januari 2026), Untuk Erha Clinic Cirebon 1 Pc (27 November 2025)"
    },
